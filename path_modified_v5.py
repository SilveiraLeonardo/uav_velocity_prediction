...
def captureImages(writeFiles, run):
	...
	while writeFiles.value == 1:
		...
		if not os.path.exists("C:/Users/drones/Documents/Leonardo_Mateus/scripts_leo_mateus/dataset/images_{}".format(str(run.value))):  
			os.makedirs("C:/Users/drones/Documents/Leonardo_Mateus/scripts_leo_mateus/dataset/images_{}".format(str(run.value)))	

		if not os.path.exists("C:/Users/drones/Documents/Leonardo_Mateus/scripts_leo_mateus/dataset/notes_{}".format(str(run.value))):  
			os.makedirs("C:/Users/drones/Documents/Leonardo_Mateus/scripts_leo_mateus/dataset/notes_{}".format(str(run.value)))	
		...
		cv2.imwrite("C:/Users/drones/Documents/Leonardo_Mateus/scripts_leo_mateus/dataset/images_{}/".format(str(run.value)) + str(framecounter) 
		...
		with open("C:/Users/drones/Documents/Leonardo_Mateus/scripts_leo_mateus/dataset/notes_{}/".format(str(run.value)) + str(framecounter) 
...
if __name__ == '__main__':  
    ...
    # total de imagens = 92361
		...
		list_of_points = []
		for _ in range(5000):
			x = int(np.random.randint(-300,300))
			y = int(np.random.randint(-300,300))
